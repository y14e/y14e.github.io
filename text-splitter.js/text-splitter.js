const NOBR_PREFERRED_REGEXP = /[[^\p{sc=Han}\p{sc=Hang}\p{sc=Hira}\p{sc=Kana}]&&[\p{L}\u0021-\u002C\u002E-\u003E\u0040\u005B-\u0060\u007B-\u007E\u00A0]]+/gv;
const NOBR_FALLBACK_REGEXP = /[\p{sc=Latn}\p{sc=Cyrl}\u0021-\u002C\u002E-\u003E\u0040\u005B-\u0060\u007B-\u007E\u00A0]+/gv;
const NOBR_REGEXP = NOBR_PREFERRED_REGEXP.test('a') ? NOBR_PREFERRED_REGEXP : NOBR_FALLBACK_REGEXP;
